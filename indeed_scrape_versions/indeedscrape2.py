...
"""
        print('base_url type')                        #JCS 2-27-2018
        print(type(base_url))                         #JCS 2-27-2018
        print(base_url)                               #JCS 2-27-2018

        #for link in job_link_area.find_all('a'):
        for link in job_link_area.find_all(href=re.compile("/rc/")):    #JCS 3-1-2018
                       testvar = link.get('href')     #JCS 2-27-2018
        print('job links\n')
        print(testvar)                                #JCS 2-27-2018
        
        job_URLS = [base_url + testvar]               #JCS 2-27-2018
"""
...
job_URLS = [base_url + link.get('href') for link in job_link_area.find_all('a')] # Get the URLS for the jobs
    ...
    #final_frame.sort(columns = 'NumPostings', ascending = False, inplace = True)   #JCS 2/27/2018 not working
    ...
    #return fig, final_frame # End of the function                                   #JCS 2-27-2018. not working
    print(final_frame)                                                          #JCS 2-27-2018
